// conges.js
// Congelaciones — BDD pendiente de conexión
...
function renderGrilla(semana) {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    // Congelaciones del día (filtrar por fecha cuando haya datos)
...
const dashboardData = [
  ...
  { patologo: 'RODRÍGUEZ',      meses: [28, 26, 31, 25, 11, 0,0,0,0,0,0,0] },
...
const DIAS_AP  = ['Domingo','Lunes','Martes','Miércoles','Jueves','Viernes','Sábado'];
const MESES_AP = ['ene.','feb.','mar.','abr.','may.','jun.','jul.','ago.','sep.','oct.','nov.','dic.'];

// Datos de ejemplo — conectar a BDD
const agendaPatologoData = [
  { id:1, patologo:'COSTOYA, M',  estado:'Agendada',   fecha:'2026-05-15', hora:'15:30', ubicacion:'Instituto Quirúrgico del Callao', medico:'Dra. Santamaría, Antonella', paciente:'FRENCH, SOLANGE',    cobertura:'UNIÓN PERSONAL', tipo:'QR',  procedimiento:'BRQ + GC' },
  { id:2, patologo:'COSTOYA, M',  estado:'Agendada',   fecha:'2026-05-19', hora:'07:30', ubicacion:'Sanatorio Suizo Argentina',       medico:'Dr. Loza, Carlos Martín',    paciente:'MARCENARO, SUSANA',  cobertura:'SMG',            tipo:'GI',  procedimiento:'Congelación de mama' },
  { id:3, patologo:'COSTOYA, M',  estado:'Agendada',   fecha:'2026-05-26', hora:'15:00', ubicacion:'IADT',                            medico:'Dra. Barchuk, Sabrina',      paciente:'GINOCCHIO, MARISA',  cobertura:'OSDE',           tipo:'QR',  procedimiento:'MAMA, CUADRANTECTOMÍA CON BIOPSIA GANGLIONAR UNILA' },
  { id:4, patologo:'COSTOYA, M',  estado:'Confirmada', fecha:'2026-05-16', hora:'09:00', ubicacion:'IADT',                            medico:'Dr. Pérez, Juan',            paciente:'RODRÍGUEZ, ANA',     cobertura:'OSDE',           tipo:'GI',  procedimiento:'Biopsia de tiroides' },
  { id:5, patologo:'COSTOYA, M',  estado:'Confirmada', fecha:'2026-05-20', hora:'11:00', ubicacion:'Centro Medicus',                  medico:'Dra. García, María',         paciente:'LOPEZ, ROBERTO',     cobertura:'SWISS MEDICAL',  tipo:'PUN', procedimiento:'Biopsia ganglionar' },
  { id:6, patologo:'DOMENIANNI',  estado:'Agendada',   fecha:'2026-05-22', hora:'08:00', ubicacion:'IADT',                            medico:'Dr. Núñez, Pablo',           paciente:'MARTÍNEZ, LAURA',    cobertura:'OSDE',           tipo:'GI',  procedimiento:'Congelación hepática' },
  { id:7, patologo:'DOMENIANNI',  estado:'Confirmada', fecha:'2026-05-23', hora:'10:30', ubicacion:'Sanatorio Suizo Argentina',       medico:'Dra. Torres, Claudia',       paciente:'GÓMEZ, PEDRO',       cobertura:'PAMI',           tipo:'QR',  procedimiento:'Nódulo tiroideo' },
];
...
function initAgendaPatologo() {
  ...
  sel.innerHTML = '<option value="">[ Seleccionar patólogo ]</option>' +
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // Ocultar filtros compartidos en Dashboard y Agenda patólogo
